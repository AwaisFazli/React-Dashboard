...
import { FiShoppingCart, fiShoppingCart } from "react-icons/fi";
  ...
  return (
    <div className="flex - justify-between p-2, md:mx-6 relative">
      ...
      <div className="flex">
        ...
        <TooltipComponent value="Profile" position="BottomCenter">
          <div
          ...
          >
            ...
            <p>
              <span className="text-gray-400 text-xl">Hi, </span>
